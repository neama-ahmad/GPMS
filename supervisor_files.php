...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if(isset($_POST['send-btn'])){
    ...
    $query1 = mysqli_query($db,"SELECT * FROM group_supervisor WHERE user_id = '$user_id' ");
  ...
  if(in_array($fileType, $allowTypes)){ 
    ...
    $query = mysqli_query($db,"INSERT INTO files (docs, file_Name, group_id, user_id, supervisor) VALUES ('$name','$file_Name','$group_id','$user_id', 1)"); 
    $msg = "تم رفع الملف";
  }
    ...
    <br/>
         ...
         <h3 >ملفات المجموعة</h3><br/>
            ...
            while($row = mysqli_fetch_array($query)){
              ...
              $query1 = mysqli_query($db,"SELECT * FROM group_supervisor WHERE user_id = '$userID' ");
              while($row1 = mysqli_fetch_array($query1)){
                $group_id = $row1['group_id'];
