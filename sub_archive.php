...
<body>
    ...
    <div id="mother">
      <?php
        echo'
        <a href="archive.php" class="Toback">&#8594;</a>';
        ?>
                ...
                <form method ="POST" action ="">
                   <h3>تفاصيل مشروع التخرج</h3><br/>
                    ...
                    <tr><th>اسم المشروع</th><td><?php echo $row['Project_Name']; ?></td></tr>
                        ...
                        <tr><th>ملف المشروع</th><td><a href="reportOpen.php?ID=<?php echo $row['ID'];?>" class="file-btn" target="_blank">   <i class="fa-solid fa-download"></i>  <?php echo $row['project_file'];?></a></td></tr>
                    </table>
                    </table>
                    
                    <input type="hidden"  name="ID" value= "<?php echo $row['ID']?>" readonly>
                    <input type="submit" name="del-btn"  class="button del-btn" value="حذف">
                </form>
            </div>
        </div> 
        <?php } ?> 
