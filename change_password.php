    ...
    if(isset($_POST["btn-add"])){
        ...
        while($row1 = mysqli_fetch_array($query1)){
            ...
            if($password != $confirm_password){
                ...
                $msg="يجب أن تتكون كلمة المرور من حروف إنجليزية صغيرة وكبيرة وأرقام ورموز";
            }
        
            else{
                //change user's password
                $change_password = mysqli_query($db, "UPDATE user SET password = '$password' WHERE ID = '$userID' ");
          ...
          ?>
           <div class="column">
            ...
            <form method="POST" action="">
                ...
                ?>
                    <h4>كلمة المرور الحالية</h4>
                    <input type="text" name="old_password"   value="<?php echo $row['password'] ?>" class="forminput" minlength="8"  required readonly>
                    <input type="text" name="password" placeholder=" ادخل كلمة المرور الجديدة " class="forminput" minlength="8"  required>
                    <input type="text"  name="confirm_password" placeholder=" قم بإدخال كلمة المرور الجديدة مرة أخرى للتأكيد" class="forminput" minlength="8" required>
