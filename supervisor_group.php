...
<body>
        ...
        <!--mother show-->
        <div id="mother">
            <h3 class="title">المجموعات</h3><br/>
            ...
            <?php
                ...
                $query = mysqli_query($db,"SELECT * FROM group_supervisor WHERE user_id = '$userID' ");
                ...
                echo '<a href="supervisor_sub_group.php?link='.$Group_id.'" class="button new-btn">  <i class="fa-solid fa-group"></i>    '.$Group_Name.'   </a><br/>';
            }}} }
