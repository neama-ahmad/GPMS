            ...
            if($member_role != 'طالب'){
                ...
                if($member_Active == 0 ){
                    ...
                    if($count2 == 1) {
                        ...
                        //check member gender
                        if($part == 'طالبات' && $member_gender == 'ذكر'){
                            $msg="لا يمكن إضافة طالب إلى المجموعة";
                        }
        
                        elseif($part == 'طلاب' && $member_gender == 'أنثى'){
                            $msg="لا يمكن إضافة طالبة إلى المجموعة";
                        }

                    
                        else{

                            $query = mysqli_query($db, "INSERT INTO group_members(group_id, user_id) VALUES ('$Group_id','$member_userID')");
                         
                            echo "<script> window.location.href='sub_manageGroup.php?link=$Group_id' </script>";
