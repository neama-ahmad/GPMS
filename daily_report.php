...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if(in_array($fileType, $allowTypes)){ 
    ...
    $query = mysqli_query($db,"INSERT INTO reports (docs, file_Name,group_id,user_id, report_type) VALUES ('$name','$file_Name','$group_id','$user_id', 'daily_report')"); 
    $msg = "تم رفع التقرير";
  }
...
<head>
  ...
  <title>نظام إدارة مشاريع التخرج | رفع تقارير دورية</title>
...
<body>
 ...
 <div id="mother">
    ...
    <form method="POST" action="" enctype="multipart/form-data">
      <h3>رفع التقارير الدورية</h3>
      <?php if (!empty($msg)) {
        echo "<p class='error' style='color:green; font-size:16px; padding:5px 22px;'>$msg</p>";
      } ?>
      <input type="text" name="file_Name" class="forminput" placeholder="قم بتسمية التقرير" required>
      <h4>قم برفع التقرير من هنا</h4>
    ...
    <br/>
         ...
         <h3 >تقاريرك</h3><br/>
            ...
            while($row = mysqli_fetch_array($query)){
              ...
              $query2 = mysqli_query($db,"SELECT * FROM reports WHERE group_id = '$group_id' AND report_type = 'daily_report' ORDER BY upload_Time DESC ");
           ...
           <div class="column2">
                ...
                <table>
                <tr><td class="bold">اسم التقرير</td><td><?php echo $file_Name;?></td></tr>
                <tr><td class="bold">وقت الرفع</td><td><?php echo $upload_Time;?></td></tr>
                </table>
            </div>
